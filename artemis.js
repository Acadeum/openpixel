...
var Pixel = /*#__PURE__*/function () {
  function Pixel(event, timestamp, optional, ajax) {
    ...
    value: function buildParams() {
      ...
      for (var index in attr) {
        if (attr.hasOwnProperty(index)) {
          ...
          this.userData[index] = attr[index](index)
        }
      }
    }
  }, {
...
pixelFunc.process = function (method, value, optional, ajax) {
  if (method === 'init') {
    Config.id = value;
    ...
    if (value === 'pageload' && !Config.pageLoadOnce) {
      ...
      new Pixel(value, pixelFunc.t, optional, ajax);
    } else if (value !== 'pageload' && value !== 'pageclose') {
      new Pixel(value, Helper.now(), optional, ajax);
    }
  }
